...
namespace relis.ViewModels
{
    ...
    public class CelulaListViewOcorrencia : ViewCell
    {
        public CelulaListViewOcorrencia ()
        {
         ...
         //   var image = new Image();
            ...
            //set bindings
            left.SetBinding(Label.TextProperty, "nm_lanc");
            right.SetBinding(Label.TextProperty, "nm_banco");

            dtlanc.SetBinding(Label.TextProperty, "dt_lanc");
            vllanc.SetBinding(Label.TextProperty, "vl_lanc");
